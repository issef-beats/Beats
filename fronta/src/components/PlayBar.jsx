...
function MusicPlayer() {
  ...
  return (
    ...
    <div
        class="bg-black border-lime-500 transition-all duration-500 dark:bg-slate-800 transition-all duration-500 dark:border-slate-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8">
        <div class="flex items-center space-x-4">
            ...
            <div class="min-w-0 flex-auto space-y-1 font-semibold">
                ...
                <p class="text-slate-500 transition-all duration-500 dark:text-slate-50 text-lg">
                    Full Stack Radio
                </p>
            </div>
        </div>
    ...
    <div
        class="bg-black text-slate-300 transition-all duration-500 dark:bg-slate-600 transition-all duration-500 dark:text-slate-200  flex items-center">
      ...
      <svg width="24" height="24" fill="none">
        ...
        <button type="button" class="bg-lime-500 text-white  transition-all duration-500 dark:bg-slate-100 transition-all duration-500 dark:text-slate-700 flex-none -my-2 mx-auto w-20 h-20 rounded-full ring-1 ring-lime-500 shadow-md flex items-center justify-center" aria-label="Pause">
    <svg width="30" height="32" fill="currentColor">
      ...
      <svg width="24" height="24" fill="none">
        ...
        <path d="M18 6v12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <button type="button" class="rounded-lg text-xs leading-6 font-semibold px-2 ring-2 ring-inset ring-slate-300 text-slate-300 transition-all duration-500 dark:text-slate-100 transition-all duration-500 dark:ring-0 transition-all duration-500 dark:bg-slate-500">
      1x
    </button>
        </div>
    </div>
